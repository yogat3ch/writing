...
The questions are derived from the reader highlights added during the refinement phase. All sections with highlighting are translated to questions by AI, with a point score attributed to each question based on the aggregated number of highlights made on that section. The score is used as a weighting system that is algorithmically balanced with 
...
MDQ2NjU3NTc0ODR9fSwiaGlzdG9yeSI6Wy02ODc3ODczMTldfQ
==
-->