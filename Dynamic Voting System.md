...
1.  **Proposal**: In this phase, legislation can be proposed and amended by participants. It's the initial stage where ideas are put forward and refined through collaborative efforts. It is at this point that user's can begin highlighting, comme
...
To qualify to vote on a piece of legislation, each person must pass a **comprehension quiz** of randomized questions. The questions are drawn from a bank of questions & answers that is either a) generated by AI or b) user submitted, covering the **key points** of a piece of legislation. A question about a given **key point** will have multiple AI generated iterations that preserve the original intent and answer to the question in order to expand the bank of possible derivatives displayed to users.  All question and answer pairs are approved by the proposers & amenders of the legislation, collectively the **legislation proposal team**. 
The **key points** are selected from all user's highlights retained in the final text of the legislation. All highlights are translated to questions by AI or optionally by user submissions, with a point score attributed to each question based on the aggregated number of highlights made on that section. The aggregated highlights are used as a measure of the relative importance of the section to human readers. All AI and user submitted questions related to the highlight will have a score attributed that will determine the frequency of its appearance in **comprehension quizzes** that is algorithmically balanced by a randomization score to determine overall frequency of appearance. The randomization score is used to ensure the rotation of questions between **comprehension quiz** deliveries. The number of questions in a **comprehension quiz** will be proportional to the number of **key points** in the legislation. In order to vote on a piece of legislation, a voter must pass the **comprehension quiz** with a score above the threshold set for that layer of the political hierarchy.
...
RleHQiOiJzZXZlbiIsInN0YXJ0Ijo2OTA0LCJlbmQiOjY5MDl9
LCI0TFA3V2pSZkVsWTZtSmdOIjp7InRleHQiOiJudW1iZXIgY2
FuIGJlIGJyb3VnaHQgdG8gdm90ZSBkdXJpbmcgYW55IGxlZ2lz
bGF0aXZlIGN5Y2xlIiwic3RhcnQiOjcxMDgsImVuZCI6NzE2Nn
0sIjRwMHpmQm51N2FLaG9rMGMiOnsidGV4dCI6ImZhaWxzIHRo
ZSB2b3Rpbmcgcm91bmQiLCJzdGFydCI6OTU2MSwiZW5kIjo5NT
YxfSwidERoUHNxeXNyaXNMbWUzVyI6eyJ0ZXh0IjoiZmFpbHMg
dGhlIHZvdGluZyByb3VuZCIsInN0YXJ0Ijo4MDY0LCJlbmQiOj
gwNjR9LCJ5U2dMeXhhY1haZUJUOEMwIjp7InN0YXJ0IjoxODkx
MCwiZW5kIjoxODkzMiwidGV4dCI6IioqQWZmaW5pdHkgVGhyZX
...
MTk4fX0sImhpc3RvcnkiOlsxODIxNDcwNjJdfQ==
-->