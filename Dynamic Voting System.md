...
A pane of the app will be entitled Representatives and will provide an interface for selecting Representatives for  **topic area** s.  Irepresentative selection pane, there will be a sorted table of other users who've opted to serve as representatives, ranked based on the percentage of alignment of between their votes and answers on the **Introductory Questionnaire** as well as a navigation system to drill down on the **representative profile,** or all of the representative's activity within the app. Any user can be a potential representative for another user. 
...
MDQ2NjU3NTc0ODR9fSwiaGlzdG9yeSI6WzIxMzQzNTYzMTQsLT
U4MDk4MjM5OV19
-->